    ...
    public class APIController : Controller
    {
        ...
        public IActionResult DeleteFriend(string id)
        {
           // var userId = _accountService.UserManager.GetUserId(this.User);
            _friends.Delete(int.Parse(id), null);
        ...
        {
            //var userId = _accountService.UserManager.GetUserId(this.User);
            FriendsViewModel friend = _friends.Get(null).FirstOrDefault(x => x.Id == int.Parse(id));
        ...
        {
            //var userId = _accountService.UserManager.GetUserId(this.User);
            FriendsViewModel friend = new FriendsViewModel { Name = name, Email = email, Phone = phone, Id = int.Parse(id), UserId = null };
            _friends.Put(friend);
